...
let MailService = MailService_1 = class MailService {
    ...
    onModuleInit() {
        ...
        const passRaw = this.config.get('SMTP_PASS');
        ...
        const secureEnv = this.config.get('SMTP_SECURE', 'false');
    ...
    async sendMail(options) {
        ...
        const from = this.config.get('MAIL_FROM') || this.config.get('SMTP_USER');
        try {
